...
user4 = User.create!(pseudonyme: "Camille",
  ...
  password: 'password',
  password_confirmation: 'password',
  image_url: "https://i.imgur.com/7VtAuwV.jpeg")
...
puts 'Generate Friends'
 ...
 friend1 = Friend.create!(first_name: "Romain",
  ...
  content: "Il aime la compétition, coder et jouer aux jeux vidéos. Il apporte la fraicheur et les blagues douteuses.",
  available: true,
  gender: 'Homme cis',
  age: 29,
 ...
 friend2 = Friend.create!(first_name: "Jonathan",
  ...
  content: "Elle aime et pratique la musique, boire des bières et régler les galères de code. Elle apporte la sagesse et la communication.",
  available: true,
  gender: 'Femme cis',
  age: 35,
  ...
  friend4 = Friend.create!(first_name: "Benoît",
    ...
    content: "Il aime la voile, l'aviation, les sports mécaniques (vroum vroum), les kebabs et faire le hater sur X. Il apporte la mauvaise humeur, des clopes de temps et temps et du CBD.",
    available: true,
    gender: 'Homme cis',
    age: 35,
    good_at: "Écrire des avis google assassins",
    price: 20,
