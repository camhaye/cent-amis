...
Friend.create(first_name: "Camille",
  location: "Toulouse",
  content: "Elle aime la littérature, enseigner et passer des heures à regarder des films. Elle apporte la joie, la bonne humeur (ish) et les blagues nulles.",
  gender: "Femme cis",
  available: true,
  age: 25,
 ...
 Friend.create(first_name: "Bastien",
  location: "Bayonne",
  content: "Il aime le surf, le pingpong (en ce moment et quand il gagne), la musique et sortir le soir. Il apporte les bières, la joie de vivre et les blagues nulles.",
  available: true,
  gender: 'Homme cis',
  age: 25,
 ...
 Friend.create(first_name: "Romain",
  location: "Bordeaux",
  content: "Il aime la compétition, coder et jouer aux jeux vidéos. Il apporte la fraicheur et les blagues nulles",
  available: true,
  gender: 'Homme cis',
  age: 29,
  good_at: "Gagner aux blind-test",
  price: 30,
 ...
 Friend.create(first_name: "Jonathan",
  location: "Bordeaux",
  content: "Il aime la géologie, enseigne, voyager et passer du temps avec ses proches. Il apporte les bons conseils et fait un excellent good cop.",
  available: true,
  gender: 'Homme cis',
  age: 39,
 ...
 Friend.create(first_name: "Anne-Cécile",
  location: "Bordeaux",
  content: "Elle aime et pratique la musique (guitare), boire des bières et régler les soucis de code. Elle apporte la sagesse et la communication.",
  available: true,
  gender: 'Femme cis',
  age: 35,
  good_at: "Faire danser le dancefloor sur un solo de guitare",
  price: 5,
